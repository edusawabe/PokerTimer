...
public class MailResultContent {
    ...
    public String toStringHTML(){
        ...
        ret = ret + "<P>Premiação 2o        : " + premio2 + "</P>";
        ret = ret + "<P>Premiação 3o        : " + premio3 + "</P>";
        ret = ret + "<P>Premiação 4o        : " + premio4 + "</P>";
        ret = ret + "<P>Premiação 5o        : " + premio5 + "</P>";
        ...
        ret = ret + "<P>*********************************************************</P>";
        ret = ret + "<P>Lista de Eliminações: " + "</P>";
        for (int i = 0; i < outs.size(); i++) {
